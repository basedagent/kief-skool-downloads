...
# The immutable bootstrap alternative uses the public v0.2.0 tag instead of main.
# To download manually:
# gh release download v0.2.0 --repo basedagent/kief-skool-downloads --pattern 'kief-skool-0.2.0.tar.gz' --pattern SHA256SUMS
# /bin/bash scripts/install.sh --version 0.2.0 --archive /absolute/kief-skool-0.2.0.tar.gz --checksums /absolute/SHA256SUMS
