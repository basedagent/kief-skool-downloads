...
# The immutable bootstrap alternative uses the public v0.2.1 tag instead of main.
# To download manually:
# gh release download v0.2.1 --repo basedagent/kief-skool-downloads --pattern 'kief-skool-0.2.1.tar.gz' --pattern SHA256SUMS
# /bin/bash scripts/install.sh --version 0.2.1 --archive /absolute/kief-skool-0.2.1.tar.gz --checksums /absolute/SHA256SUMS
...
try {
  ...
  const version = opts['--version'] || '0.2.1';
